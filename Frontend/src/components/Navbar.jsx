...
const Navbar = () => {
  ...
  return (
    <>
      <div className={` max-w-screen-2xl z-10 container mx-auto md:px-20 px-4 dark:bg-slate-900 dark:text-white  fixed top-0 right-0 ${
        sticky
        ...
        <div className="navbar  ">
          ...
          <div className="navbar-end space-x-2">
           ...
           
           {
            authUser? <Logout />:
            <div className="">
              <a className=" bg-black px-3 py-2 cursor-pointer text-white hover:bg-slate-800 duration-300 rounded-md" onClick={()=>document.getElementById("my_modal_3").showModal()}>
                login
              </a>
              <Login />
            </div> 
